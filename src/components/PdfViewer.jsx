      ...
      >
        <div className="flex items-center gap-2">
          <button
            ...
            className="text-xs px-2 py-1 rounded hover:bg-white/5 disabled:opacity-30"
        ...
        <div className="flex items-center gap-2">
          <span style={{ color: 'var(--text-muted)' }} className="text-[10px]">
            {(docContent.length / 1000).toFixed(1)} KB
          </span>
          <span style={{ color: 'var(--text-muted)' }} className="text-[10px]">
            {docContent.split(/\s+/).length} words
          </span>
          <div className="flex items-center gap-1 ml-2">
            ...
            <span style={{ color: 'var(--text-primary)' }} className="text-[10px] font-medium w-8 text-center">
              {zoom}%
            </span>
            <button
      ...
      <div ref={containerRef} className="flex-1 overflow-y-auto p-6">
        {loading ? (
          ...
          <div className="max-w-3xl mx-auto">
            ...
            >
              <pre
                style={{ color: 'var(--text-primary)', fontSize: `${(zoom / 100) * 0.875}rem` }}
